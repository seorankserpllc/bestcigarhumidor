...
export const AMAZON_PRODUCTS: AmazonProduct[] = [
  ...
  // ================= ACRYLIC & AIRTIGHT =================
  {
    ...
    slug: 'tisfa-small-acrylic-cigar-humidor-review',
    name: 'TISFA Small Acrylic Cigar Humidor',
    brand: 'TISFA',
    category: 'acrylic',
    price: 0,
    priceBracket: '$',
    priceTierFormatted: '$ (Compact acrylic storage)',
    capacitySticks: 20,
    asin: 'B09LM167T7',
    amazonSearchQuery: 'TISFA Small Acrylic Cigar Humidor B09LM167T7',
    description: 'The current small variant is a clear acrylic box with a clasp, rubber gasket, cedar at the bottom, an adjustable hygrometer and a humidifier. Its Amazon listing claims space for about 15–20 cigars depending on ring gauge.',
    highlights: ['Small clear acrylic box', 'Clasp and rubber gasket', 'Adjustable hygrometer and humidifier included', 'Listing claim: about 15–20 cigars'],
    pros: ['Compact rectangular footprint', 'Contents and hygrometer remain visible with the lid closed', 'Includes basic monitoring and humidification components'],
    cons: ['The 15–20 count is a listing claim, not an independent fit test', 'Check the included hygrometer against a trusted reference', 'No active temperature control'],
    bestFor: 'A small daily rotation when a compact rectangular acrylic box is easier to organize than a jar.',
    sealRating: 0,
  ...
  },
  {
    ...
    slug: 'klaro-felix-pro-acrylic-humidor-review',
    name: 'Case Elegance Felix Pro Acrylic Humidor',
    brand: 'Case Elegance',
    category: 'acrylic',
    price: 0,
    priceBracket: '$$$',
    priceTierFormatted: '$$$ (Large organized acrylic storage)',
    capacitySticks: 60,
    asin: 'B0CHTZWV9T',
    amazonSearchQuery: 'CASE ELEGANCE Felix Pro Acrylic Humidor B0CHTZWV9T',
  ...
  },
  {
    ...
    description: 'A clear acrylic jar with a clasp, integrated rubber gasket, Spanish cedar lining on the bottom and a removable round humidifier. The current listing claims a 25-cigar capacity and room for cigars up to 8 inches long.',
    highlights: ['Clear acrylic jar', 'Spanish cedar bottom lining', 'Listing claim: 25 cigars', 'Removable round humidifier'],
    pros: ['Compact 9-inch-tall jar format', 'Contents remain visible without opening', 'The acrylic shell does not need full wood-box seasoning'],
    cons: ['No hygrometer is included in the current listing', 'The 25-cigar figure is a listing claim', 'Cigars at the bottom are less convenient to reach'],
    bestFor: 'A small collection when a simple upright jar matters more than trays or an included gauge.',
    sealRating: 0,
