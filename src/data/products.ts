...
export const AMAZON_PRODUCTS: AmazonProduct[] = [
  ...
  },
  {
    ...
    description: 'A slim dedicated humidity and temperature display for users who prefer an in-humidor readout instead of a phone app. The current ASIN is the Caliber V, not the discontinued Caliber IV name previously shown.',
